...
def send_welcome_email(to_email, name):
    subject = "Welcome to LeftoverChef! 🍳"
    body = f"""Subject: {subject}

Hi {name},

Welcome to LeftoverChef – your AI-powered kitchen companion!
...
def signup():
    try:
        ...
        try:
            ...
            pass  # Email failed but signup still succeeds
...
def send_meal_reminder():
    try:
        ...
        subject   = "⚠️ Ingredients Expiring Soon – LeftoverChef"
...
Log into LeftoverChef now to generate a quick meal before they go to waste!
